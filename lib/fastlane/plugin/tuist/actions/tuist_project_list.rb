...
module Fastlane
  module Actions
    class TuistProjectListAction < Action
      def self.run(params)
        command = ['list']
      ...
      def self.available_options
        [
          FastlaneCore::ConfigItem.new(
            key: :path,
            description: "The path to the directory or a subdirectory of the project (env: TUIST_PROJECT_LIST_PATH)",
            optional: true,
            type: String
          ),
          ...
          FastlaneCore::ConfigItem.new(
            key: :json,
            description: "The output in JSON format (env: TUIST_PROJECT_LIST_JSON)",
            optional: true,
            type: Boolean
          ),
