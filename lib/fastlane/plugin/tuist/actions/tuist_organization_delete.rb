...
module Fastlane
  module Actions
    class TuistOrganizationDeleteAction < Action
      def self.run(params)
        command = ['delete']
      ...
      def self.available_options
        [
          FastlaneCore::ConfigItem.new(
            ...
            description: "The name of the organization to delete (env: TUIST_ORGANIZATION_DELETE_ORGANIZATION_NAME)",
            optional: false,
            type: String
          ),
          ...
          FastlaneCore::ConfigItem.new(
            key: :path,
            description: "The path to the directory or a subdirectory of the project (env: TUIST_ORGANIZATION_DELETE_PATH)",
            optional: true,
            type: String
          ),
